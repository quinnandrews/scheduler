...
/**
 * <p> Indicates that a given Request was malformed or somehow invalid. Corresponds
 * to an HTTP Status Code of 400.
 *
...
public class BadRequestException extends RuntimeException {
    ...
    public BadRequestException(final String message, final String description) {
        super(message);
